...
export const pageEstructure = async () => {
    try {
        let response = await axios.get(`${ESTRUCTUREPOINT}/customer/signup/pages`);
        return response.data
...
export const signup = async (data: any) => {
    try {
        let response = await axios.post(`${ENDPOINT}${PREFIX}/auth/signup/custom/basic-info`, data);
        return response.data;
    } catch (error: any) {
        if (error.response) {
            return error.response.data
...
export const logOut = async (data: any) => {
    try {
        let response = await axios.get(`${ENDPOINT}${PREFIX}/auth/signup/custom/basic-info`, data);
        return response.data;
    } catch (error: any) {
        if (error.response) {
            return error.response.data
...
export const updateMetaDataUser = async (data: any) => {
    ...
    try {
        let response = await axios.put(`${ENDPOINT}${PREFIX}/auth/signup/custom/${usuario._id}/metadata`, data);
        return response.data;
    } catch (error: any) {
        if (error.response) {
            return error.response.data
