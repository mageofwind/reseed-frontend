    ...
    <div className="signUpContainer">
      <div className="borderContainer">
        <div className="icon_reseed_container_form_home">
          ...
          />
          <p className="welcome_title_form_client">Project Proponent <br />Sign-Up</p>
        </div>
        {accountValidated ?
          ...
          <div>
            ...
            <div className="su_question">
              <p className="doyouhaveanaccount_text">Do you have an account?
